...
function Sidebar({
  ...
  return (
    <>
      <div
        id="default-sidebar"
        className="absolute top-20 left-0 z-40 w-1/4 h-screen pt-0 transition-transform -translate-x-full sm:translate-x-0 bg-gray-50 dark:bg-gray-800"
        aria-label="Sidebar"
      >
          ...
          <div className="grid grid-cols-2 gap-3 mx-8">
            <div className="flex items-center  px-2 py-1  text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-400 bg-gray-200 dark:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700">
              ...
              >
                <svg
                  aria-hidden="true"
                  className="flex-shrink-0 w-3 h-2 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                  xmlns="http://www.w3.org/2000/svg"
                >
                ...
                <span className="inline-flex items-center justify-center w-3 h-3 p-1 ml-1 text-sm font-medium text-blue-800 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300">
                  0
                </span>
              </a>
            </div>
      ...
      <div className="absolute justify-center w-5/6 h-full top-20 left-1/4 border-0">
        ...
        <div className="absolute justify-center z-5 flex flex-1 border-0 border-gray-200 rounded-lg dark:border-gray-700 ">
          <div className="grid p-4 grid-cols-3 gap-4 mb-4 ">
            {teleport12 && <Alert text={"Press SPACE to teleport"} />}
            {showShopText && <Alert text={'Press "SPACE" to Open Shop'} />}
          </div>
        </div>
        {/* <div className="absolute justify-center z-5 flex flex-1 border-0 border-gray-200 rounded-lg dark:border-gray-700 ">
        ...
        <div className="absolute justify-center w-full flex flex-1 border-0 border-gray-200 rounded-lg dark:border-gray-700 ">
          {showUniswap && <Iframe iframe={iframe} />}
        </div>

        <div className="absolute justify-center w-full flex flex-1 border-0 border-gray-200 rounded-lg dark:border-gray-700 ">
          {showDialogBox && (
            <MessageBox message={message} onDone={dialogDone} />
          )}
        </div>
        <div className="absolute justify-center w-full border-0 border-gray-200 rounded-lg dark:border-gray-700 ">
          {showLogin && <SigninBox message={message} Signin={loginDone} />}
        </div>
        <div className="absolute justify-center w-full flex flex-1 border-0 border-gray-200 rounded-lg dark:border-gray-700 ">
          {showShop && (
            <ShopUI />

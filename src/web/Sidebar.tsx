...
{/* 
        <div className="pt-20"> */}
        <div className="absolute justify-center top-20 left-64 w-full h-full flex border-0">
            <div className="absolute justify-center z-5 flex border-0 border-gray-200 rounded-lg dark:border-gray-700 ">
            ...
            <div className="absolute justify-center w-full flex border-0 border-gray-200 rounded-lg dark:border-gray-700 ">
                {showUniswap && 
            ...
            <div className="absolute justify-center w-full pt-20 pl-64 flex border-0 border-gray-200 rounded-lg dark:border-gray-700 ">
                {showInventory && (
                    <InventoryUI />
                    // <Shop message={message}
                    // Signin={loginDone}/>
